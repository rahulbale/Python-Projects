...
submit = Button(value_Frame, text='Calculate', font=('Courier', 14),bg="#008CBA")
submit.bind("<Button-1>",BMI_calculator)
submit.bind("<Key>",BMI_calculator)
submit.grid(row=3, column=1, pady=20, ipadx=50, ipady=3)

txt = Text(value_Frame, width=30, height=2, wrap=WORD, font=("times new roman",12,"bold"),bg="#00cc00")
